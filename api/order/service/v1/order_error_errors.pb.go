...
func IsRecordNotFound(err error) bool {
	...
	return e.Reason == OrderServiceErrorReason_RECORD_NOT_FOUND.String() && e.Code == 404
}

func ErrorRecordNotFound(format string, args ...interface{}) *errors.Error {
	return errors.New(404, OrderServiceErrorReason_RECORD_NOT_FOUND.String(), fmt.Sprintf(format, args...))
}
